					...
					<div className="about">
						...
						<div className="card quote">
							...
							<div className="card mb-3 ">
								...
								<img src={require('../../images/Jai-Miller-baseball.jpg')} className="card-img" alt="Jai-smiling" width='1160'/>
								</div>
							</div>
							</div>
							...
							<div className="card mb-3">
								<div className="row">
									<div className="col-md-4">
										<div className="">
											<img src={require('../../images/Jai-kneel.JPG')} className="card-img" alt="Jai-kneeling" width='360'/>
										</div>
									</div>
								...
								<div className="row">
									...
									<div className="col-md-8">
										<div className="about-content">
											<div className="card-body">
												...
												I went on to play professional baseball for 10 years and received a degree in Mechanical Engineering. Yep, my brain muscle is just as defined as my body! </p>
												<p>As you have read, fitness has had tremendous power in creating the foundations for my physical and mental wellness. It can be used as a tool to condition the
												 body and mind so that it performs at an optimal state of health and energy. I want to be able to help people learn how to use that tool successfully.
												</p>
									...
									<div className="col-md-4">
										<div className="">
											...
											<img src={require('../../images/Jai-back.jpeg')} className="card-img" alt="Jai-back" width='360'/>
											</div>
