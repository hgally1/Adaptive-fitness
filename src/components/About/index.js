									...
									<div className="col-md-7">
										<div className="about-content">
											<div className="card-body">
												...
												It can be used as a tool to condition the body and mind so that it performs at an optimal state of health and energy. And I want to be able to help people learn how to use that tool successfully.</p>
